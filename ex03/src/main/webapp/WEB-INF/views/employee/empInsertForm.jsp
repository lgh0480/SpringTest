...
<body>
	...
	<form role="form" action="${not empty emp? 'updateEmp': 'empInsert'}" method="post" id="frm" name="frm">
		...
		<div class="form-group">
			<label>사원번호</label> 
			<input type="text" name="employeeId" id="employeeId" value="${emp.employeeId }">
		</div>

		<div class="form-group">
			<label>First name</label><span class="require">*</span>
			<input type="text" name="firstName" id="firstName"value="${emp.firstName }">
		</div>
		
		<div class="form-group">
			<label>Last name</label><span class="require">*</span>
			<input type="text" name="lastName" id="lastName"value="${emp.lastName }">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="commissionPct" id="commissionPct">
		</div>
		
		<div class="form-group">
			<label>매니저번호</label>
			<input type="text" name="managerId" id="managerId"><input id="name">
			<button type="button" class="btn btn-primary" id="btnEmpSearch">매니저검색</button>
		</div>
